    ...
    <main className="app-content" dir={isRtl ? 'rtl' : 'ltr'}>
      ...
      <section className="lumiere-split hero-viewport">
        ...
        <div className="split-left" style={{ justifyContent: 'center', alignItems: 'center', textAlign: 'center' }}>
          ...
          <h1 style={{ fontSize: 'clamp(2.2rem, 6vw, 3.5rem)', fontWeight: 300, letterSpacing: '-0.02em', margin: '0 0 24px', textAlign: 'center', lineHeight: 1.1 }}>
            {isRtl ? 'عن' : 'ABOUT'}
            <br />
            <span style={{ fontWeight: 600 }}>{isRtl ? 'سمارت وود' : 'SMARTWOOD'}</span>
          </h1>

          <p className="smartwood-description animate-fade-up" style={{ fontSize: 'clamp(0.95rem, 2.5vw, 1.1rem)', color: 'var(--text-soft)', marginBottom: '20px', maxWidth: '600px', lineHeight: 1.75, animationDelay: '1.5s', textAlign: 'center' }}>
            {isRtl
          ...
          <p className="smartwood-description animate-fade-up" style={{ fontSize: 'clamp(0.95rem, 2.5vw, 1.1rem)', color: 'var(--text-soft)', marginBottom: '32px', maxWidth: '600px', lineHeight: 1.75, animationDelay: '1.7s', textAlign: 'center' }}>
            {isRtl
          ...
          <div className="hero-main-actions d-flex gap-3 animate-fade-up" style={{ animationDelay: '1.9s', justifyContent: 'center', flexWrap: 'wrap' }}>
