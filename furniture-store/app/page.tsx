      ...
      <section className="lumiere-split" style={{ flex: 1 }}>
        ...
        <div className="split-left" style={{ justifyContent: 'center', alignItems: 'flex-start', textAlign: isRtl ? 'right' : 'left' }}>
          ...
          <h1 className="smartwood-title" style={{ fontSize: 'clamp(2.5rem, 4vw, 4.5rem)', fontWeight: 300, letterSpacing: '-0.02em', marginBottom: '24px', lineHeight: 1.1 }}>
            <span className="text-showup" style={{ fontWeight: 800, animationDelay: '0.3s' }}>{isRtl ? 'سمارت وود:' : 'Smartwood:'}</span>
            <br />
            <span className="text-reveal" style={{ animationDelay: '0.8s' }}>
              <span className="text-slidein" style={{ animationDelay: '0.8s' }}>{isRtl ? 'حيث تلتقي أناقة الطبيعة بأحدث تقنيات الدقة.' : 'Where Nature’s Elegance Meets Cutting-Edge Precision.'}</span>
            </span>
          </h1>

          <p className="smartwood-description animate-fade-up" style={{ fontSize: '1.2rem', color: 'var(--text-soft)', marginBottom: '40px', maxWidth: '600px', animationDelay: '1.4s' }}>
            {isRtl
          ...
          <div className="hero-main-actions d-flex gap-3 animate-fade-up" style={{ animationDelay: '1.7s' }}>
